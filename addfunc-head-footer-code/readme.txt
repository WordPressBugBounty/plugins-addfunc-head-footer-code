...
Tags: head code, footer code, add to head, per page, tracking code
...
*   Fixes page specific fields by removing sanitization. Adds notice to warn users of security resks.
